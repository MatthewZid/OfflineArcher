...
class SocraticDialogueEnv():
    ...
    def _step(self, chatbot_action, user_utterance):
        # if answer.strip() == 'yes':
        #     answer = 'Yes.'
        ...
        if self.done:
            return None
        # self.count+=1
        self.history += chatbot_action + ' ' + user_utterance + '\n'
    ...
    # def generate_answer(self, user_utterance):
    ...
    def reset(self, article_prompt='', idx : Optional[int]=None):
        # self.count = 0 
        ...
        if article_prompt == '':
            ...
            self.history = str(article_prompt)
        self.done = False
        # return INITIAL_STR
        # return ''
        return self.history
    ...
    # def copy(self):
    #     return SocraticDialogueEnv(
    #         oracle=self.oracle,
    #         word_list=self.word_list,
    #         max_conversation_length=self.max_conversation_length,
    #     )

class BatchedSocraticDialogueEnv():
    ...
    def __init__(
        ...
        # self.env_list = [SocraticDialogueEnv(max_conversation_length, word_list = word_list) for _ in range(bsize)]
        self.env_list = [SocraticDialogueEnv() for _ in range(bsize)]
        self.bsize = bsize
